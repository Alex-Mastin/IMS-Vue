<template>
    <div id="editbuysale" v-title="title">
    ...
    export default {
        ...
        data() {
            return {
                ...
                carriers: [],
                capacities: [],
                title: 'Big Buys/Sales - Edit Buy/Sale | Device Pitstop - Maple Grove',
                manufacturer: '',
                model: '',
                carrier: '',
                capacity: '',
                            ...
                            .then(docSnapshot => {
                                ...
                                if (!docSnapshot.exists) {
                                    self.$root.$emit('openModal', {
                                        closed: false,
                                        text: 'An error has occurred. This transaction does not exist!',
                                        type: 'error'
                                    });
                                }
                                else {
        ...
        created() {
            ...
            database.collection('buysale').doc(this.$route.params.id).get()
                .then((docSnapshot) => {
                    ...
                    document.getElementById("buy").checked = doc.buy;
                    document.getElementById("sale").checked = doc.sale;
