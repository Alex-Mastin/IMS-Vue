                    ...
                    <div class="row product-form">
                        <div class="row-container">
                            <form id="feature-form" action="" autocomplete="off">
                                ...
                                <form-input elementId="content" label="Issue: " labelWidth="15" inputWidth="50" type="text" required tall textarea placeholder="Explain the bug you experienced"></form-input>
                                <form-input elementId="steps" label="Steps: " labelWidth="15" inputWidth="50" type="text" required tall textarea placeholder="Explain the steps required to recreate this issue"></form-input>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                title: 'Support - Submit a Bug Report | Device Pitstop - Maple Grove',
            }
        },
        methods: {
            routeTo(route) {
